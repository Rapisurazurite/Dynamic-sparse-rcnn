...
class DynamicHead(nn.Module):
    ...
    def _init_box_pooler(cfg, input_shape):
        ...
        pooler_scales = tuple(1.0 / input_shape[k].stride for k in in_features) if use_level_pooler else [
            1.0 / input_shape[in_features[0]].stride, ]
...
class RCNNHead(nn.Module):
    ...
    def apply_deltas(self, deltas, boxes):
        ...
        """
        # Convert dtype to float32, this may overflow in float16
        deltas = deltas.float()
